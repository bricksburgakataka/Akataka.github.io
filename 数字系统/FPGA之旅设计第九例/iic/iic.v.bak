...
begin
    if(rst_n == 1'b0)
        ...
        IICSlaveReg <= IICSlave;//{IICSlave[8],IICSlave[9],IICSlave[10],IICSlave[11],IICSlave[12],IICSlave[13],IICSlave[14],IICSlave[15],IICSlave[0],IICSlave[1],IICSlave[2],IICSlave[3],IICSlave[4],IICSlave[5],IICSlave[6],IICSlave[7]}; 
